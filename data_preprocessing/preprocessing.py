...
class Preprocessor:
    ...
    def scaleData(self,data):
        ...
        self.logger_object.log(self.file_object, 'Entered sacle data')
        return final_data
    ...
    def enocdeCategoricalvalues(self,data):
        ...
        data["class"] = data["class"].map(
            {"Lodgepole_Pine": 0, "Spruce_Fir": 1, "Douglas_fir": 2, "Krummholz": 3, "Ponderosa_Pine": 4, "Aspen": 5, "Cottonwood_Willow": 6})
        self.logger_object.log(self.file_object, 'Exited enocdeCategoricalvalues')
        return data
    ...
    def handleImbalanceDataset(self,X,y):
        try:
            ...
            self.logger_object.log(self.file_object, 'Exited handleImbalanceDataset')
            return X,y
        except Exception as e:
            self.logger_object.log(self.file_object, 'Exited enocdeCategoricalvalues'+str(e))
